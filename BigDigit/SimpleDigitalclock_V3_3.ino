//Tweaking "TimerOne.h" #54(long microseconds=1000283);calib offset +22sec /day .More accurate day vs GPS/NTP .
// Redundancy "	*.ino"	#41 Timer1.initialize(1000283);
...
int themin = 0;
int themin2 = 0;
int thehr = 2;    // reset start from 12:00:00 AM
int thehr2 = 11;  // 11=1 custom byte prog to displays 1 until <1 == blank byte (thehr2,thehr)
...
void loop()
{
  ...
  else if(theinput == btnDOWN && btnSelected != btnDOWN)
  {
    btnSelected = btnDOWN;
    thesec = 0;
    thesec2 = 0;
  }
  else if(theinput == btnUP && btnSelected != btnUP)
  {
    ampm=!ampm;
  }
